      ...
      body: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if (snapshot.data == null)
            ...
            if(snapshot.data !=null){
          storeName = snapshot.data['Name']==null ? "Null": snapshot.data['Name'];
          storeCnic = snapshot.data['CNIC']==null ? "Null":snapshot.data['CNIC'];
          storePhoneNo = snapshot.data['PhoneNo']==null ? "Null": snapshot.data['PhoneNo'];
          storeAddress = snapshot.data['Address']==null ? "Null":snapshot.data['Address'];
            }
